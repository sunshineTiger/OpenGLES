...
public class MyGLRenderer3 implements GLSurfaceView.Renderer {
     ...
     * 创建shader程序
     *
     * @param vertexSource   顶点
     * @param fragmentSource 片元
     * @return
     */
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program != 0) {
            ...
            // 存放链接成功program数量的数组
            int[] linkSatae = new int[1];
            // 获取program的链接情况
            GLES20.glGetProgramiv(program, GLES20.GL_LINK_STATUS, linkSatae, 0);
            if (linkSatae[0] == 0) {
