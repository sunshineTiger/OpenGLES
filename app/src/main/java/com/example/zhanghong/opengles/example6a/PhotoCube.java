package com.example.zhanghong.opengles.example6a;
...
import com.example.zhanghong.opengles.R;
...
public class PhotoCube {
    ...
    public PhotoCube(Context context) {
        ...
        @SuppressLint("ResourceType") InputStream istream = null;
